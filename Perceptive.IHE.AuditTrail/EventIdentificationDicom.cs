...
{
    public class EventIdentificationDicom : XmlSectionBase
    {
        # region Properties

        [XmlElement("EventID")]
        public ActorElementDicom EventId { get; set; }
        ...
        public ActorElementDicom EventTypeCode { get; set; }
        ...
        protected override void PopulateDefaultData(string propertyName)
        {
            ...
            EventId = new ActorElementDicom();
            EventTypeCode = new ActorElementDicom();
